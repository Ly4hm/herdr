...
The underline preserves terminal colors and is cleared on ordinary mouse motion
or input. Hover recognition does not access the filesystem; existence is checked
